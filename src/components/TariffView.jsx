  ...
  return (
    <Paper sx={{ p: 4, background: "#ffffff", display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <Stack spacing={3} sx={{ width: "100%", maxWidth: 400, alignItems: "center" }}>
        ...
        <Button variant="contained" onClick={saveGroupTariff}>Save Tariff</Button>
        ...
        <Button variant="contained" onClick={saveReplacementValue}>Save Replacement Value</Button>
